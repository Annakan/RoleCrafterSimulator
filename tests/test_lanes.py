...
def test_lane():
    ...
    reject = lane.add_card(default_card_template_L1.generate_same())
    assert len(reject) == 0
    ...
    card0 = default_card_template_L2.generate_same(cid="card0")
    ...
    card1 = default_card_template_L3.generate_same(cid="card1")
    ...
    card2 = default_card_template_L2.generate_same(cid="card2")
    ...
    card3 = default_card_template_L4.generate_same(cid="card3")
    reject = lane.add_card(card3, at_pos=4)
    assert lane.at_pos(4) == card3
    assert lane.at_pos(5) == card1
    card4 = default_card_template_L4.generate_same(cid="card4")
    ...
    card5 = default_card_template_L5.generate_same(cid="card4")
    ...
    card6 = product_card_template_L1.generate_same()
